-- Migration: 001_create_events_tables.sql
-- Description: Sets up the initial tables for events and registrations.
...
-- Drop existing trigger before creating a new one to avoid errors on re-runs
